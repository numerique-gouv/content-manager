            ...
            field=wagtail.fields.StreamField(
                [
                    ...
                    (
                        ...
                        wagtail.blocks.StructBlock(
                            [
                                ("text", wagtail.blocks.RichTextBlock(label="Rich text", required=False)),
                                (
                                    "cta_label",
                                    wagtail.blocks.CharBlock(
                                ...
                                ("cta_url", wagtail.blocks.CharBlock(label="Link", required=False)),
                            ],
                            label="Text with call to action",
                        ),
                    ),
                    (
                        "tags_list",
